...
artwork1 = Artwork.create!(title: 'nighthawks', image_url: 'https://en.wikipedia.org/wiki/Nighthawks_(painting)#/media/File:Nighthawks_by_Edward_Hopper_1942.jpg', artist_id: user1.id, favorite: false)
...
ArtworkShare.create!(artwork_id: artwork2.id, viewer_id: user2.id)#, favorite: true)
ArtworkShare.create!(artwork_id: artwork3.id, viewer_id: user3.id)#, favorite: true)
